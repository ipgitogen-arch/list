...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($chatName === '') {
        ...
        $stmt = $pdo->prepare("INSERT INTO group_chats (name, created_by, created_at, is_shared) VALUES (?, ?, NOW(), 0)");
...
// Получаем список друзей для добавления
$stmt = $pdo->prepare("
